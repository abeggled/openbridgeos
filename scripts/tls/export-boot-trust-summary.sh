...
- username: admin
- password: set during first web onboarding

Security note:
- This file does not contain a password.
- Keep the appliance on a trusted setup network until onboarding is complete.
EOF
...
No private keys or passwords were exported.
EOF
