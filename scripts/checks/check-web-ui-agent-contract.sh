...
require_contract_line 'obos-agent portable-import-stage <portable-backup> <passphrase-file> --confirm portable-import-stage'
...
require_contract_line 'POST /obos/api/v1/actions/mqtt-enable-lan'
require_contract_line '{"confirm":"mqtt-enable-lan","source_cidr":"192.168.1.0/24"}'
require_contract_line 'POST /obos/api/v1/actions/mqtt-disable-lan'
require_contract_line '{"confirm":"mqtt-disable-lan"}'
require_contract_line 'POST /obos/api/v1/actions/tls-generate'
...
require_contract_line 'sudo obosctl web-auth-rotate'
require_contract_line 'obos-agent web-auth-rotate --confirm web-auth-rotate'
require_contract_line 'POST /obos/api/v1/actions/web-auth-rotate'
require_contract_line '{"confirm":"web-auth-rotate"}'
...
require_contract_line 'POST /obos/api/v1/uploads/portable-import'
require_contract_line 'application/octet-stream'
require_contract_line 'POST /obos/api/v1/actions/portable-import-stage'
require_contract_line '{"confirm":"portable-import-stage","portable_backup":'
require_contract_line 'obos-agent start --confirm start'
...
require_contract_line 'encrypted portable backups into private staging'
