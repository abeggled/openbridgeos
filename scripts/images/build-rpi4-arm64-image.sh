...
chroot "${BUILD_ROOT}" /bin/sh -c "cd /opt/openbridgeos/${REPO_NAME} && OBOS_DISABLE_SSH=1 OBOS_APPLY_RUNTIME_HARDENING=0 sh ${OBOS_PROVISION_SCRIPT} /opt/openbridgeos/${REPO_NAME}"
